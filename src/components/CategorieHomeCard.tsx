...
export default function CategorieHomeCard({Categorie} : {Categorie : TCategorie}) {
  return (
    <Link to={`/categorie/${Categorie.id}`} className="w-md overflow-hidden border-r-8 border-r-blue-500 shadow-lg rounded-lg  flex p-4 items-center gap-15 cursor-pointer">

...
export default function Footer() {
  return (
    <div className='w-full bg-neutral-800 text-white'>
      ...
      <div className="w-full flex flex-col bg-black px-40 py-25">
        <div className="w-full flex justify-between max-lg:flex-col max-lg:gap-25">
          ...
          <div className="flex flex-col h-30 max-lg:h-auto max-lg:gap-6 max-lg:items-center flex-wrap gap-x-40 gap-4">

  ...
  return (
    <div className="w-full px-6 py-4 border-b border-b-gray-900 flex flex-col gap-6 justify-center items-center">
        <div className="flex w-full justify-between items-center">
            ...
            <div className="flex gap-4 w-1/3 justify-end items-center max-lg:hidden">
                ...
                <Link className="px-4 py-2 font-semibold text-white bg-blue-500 rounded-lg hover:bg-blue-600" to={'/'}>S'incrire</Link>
                <Link className="px-4 py-2 font-semibold rounded-lg text-blue-500 border-2 border-blue-400" to={'/'}>Se connecter</Link>
            </div>

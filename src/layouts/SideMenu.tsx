  ...
  return (
    <div className="w-1/5 h-screen flex flex-col justify-between border-r border-r-gray-100">
        ...
        <ul className="w-full flex flex-col">
            <span onClick={()=>change("Product")} className="w-full px-8 py-4 text-lg gap-2 cursor-pointer bg-gray-200 font-medium hover:bg-gray-300 flex items-center"><GiMusicalScore />Produits</span>
            <span onClick={()=>change("Categorie")} className="w-full px-8 py-4 text-lg gap-2 cursor-pointer bg-gray-200 font-medium hover:bg-gray-300 flex items-center"><BiCategoryAlt />Catégories</span>
            <span onClick={()=>change("SousCategorie")} className="w-full px-8 py-4 text-lg gap-2 cursor-pointer bg-gray-200 font-medium hover:bg-gray-300 flex items-center"><MdOutlineCategory />Sous-catégorie</span>
